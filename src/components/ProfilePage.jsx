            ...
            <div className="d-flex flex-column bg-white border border-1 rounded-3 mb-2">
              <div id="userField">
                <img
                  src={userEmpty}
                  alt=""
                  className="img-fluid object-fit-cover rounded-top-3 w-100"
                />
                <Button
                  className="p-2 bg-white border-0 z-1 rounded-circle d-flex justify-content-center"
                  id="btn-camera"
                >
              ...
              <div className="mb-4" id="userNoPhoto">
                <Button
                  className="rounded-circle bg-transparent border-0 "
                  id="addPhoto"
                >
                  <img
                    src={userImage}
                  ...
                  <div>
                    <div className="border border-1 rounded px-3 py-3 me-3">
                      <div className="d-flex justify-content-start align-items-center mb-3">
                        ...
                        <p className="m-0 ms-2 text-truncate">
              ...
              <div className="px-3 pt-2">
                <div className="d-flex justify-content-between align-items-top mb-3">
                  <div className="pt-2">
                    ...
                    <a
                      href="#"
                      className="text-primary d-flex justify-content-start align-items-center text-decoration-none"
                    >
                      0 follower
                    </a>
                  </div>
                ...
                <p className="text-secondary  fs-7 fw-light mb-2">
                  I posti che condividi appariranno qui
                </p>
              </div>
              <Button className="border-0 bg-transparent text-secondary w-100 rounded-0 rounded-bottom border-top p-0 m-0 py-2 d-flex justify-content-center align-items-center  fw-bold showBtns">
                ...
                <div className="d-flex justify-content-between align-items-top mb-3">
                  <div className="pt-2">
                    ...
                    <p className="fs-7 fw-light mb-2">
                      Metti in risalto i risultati raggiunti e ottieni fino a 2
                      volte più visualizzazioni del profilo e collegamenti
                    </p>
                    <div className="d-flex  justify-content-start align-items-center mb-3">
                      <FaBriefcase className="fs-1 p-2 text-secondary border  border-black border-1 rounded " />
                      <div className="d-flex flex-column">
                        <p className="m-0 ms-2 fs-6 text-secondary ">
                          Qualifica
                        </p>
              ...
              <div className="px-3 pt-2">
                <div className="d-flex justify-content-between align-items-top mb-3">
                  <div className="pt-2">
                    ...
                    <p className="fs-7 fw-light mb-2">
                      Mostrando le tue qualifiche avrai fino a 2 volte più
                      probabilità di ricevere in messaggio in Mail da recrutier
                    </p>
                    <div className="d-flex  justify-content-start align-items-center mb-3">
              ...
              <div className="px-3 pt-2">
                <div className="d-flex justify-content-between align-items-top mb-3">
                  <div className="pt-2">
                    ...
                    <p className="fs-7 fw-light mb-2">
                      Fai capire se hai un profilo adatto per le nuove
                      opportunità: il 50% dei recruiter usa i dati sulle
          ...
          <Col xs={2}>
            <div className="bg-white border border-1 rounded p-3 mb-2">
              ...
              <p className="text-secondary fw-light mb-3 ">
                www.linkedin.com/in/alessandro-querci-887a28239
              </p>
            </div>
