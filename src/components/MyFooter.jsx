...
const MyFooter = () => {
  return (
    <>
      <Container fluid className="bg-linkedin  " id="myFooter">
        <Row className="d-flex justify-content-center">
          <Col xs={1}>
            <div className="d-flex flex-column justify-content-start">
              <a href="#" className="text-decoration-none text-secondary fw-bold fs-7 mb-3">
                Informazioni
              </a>
              <a href="#" className="text-decoration-none text-secondary fw-bold fs-7 mb-3">
              ...
              <a href="#" className="text-decoration-none text-secondary fw-bold fs-7 mb-5">
                Centro Sicurezza
              </a>
          ...
          <Col xs={2}>
            <a href="" className="text-decoration-none text-secondary  mb-3">
              <div className="d-flex justify-content-start align-items-center mb-3">
                ...
                <div>
                  <p className="text-decoration-none text-secondary fw-bold fs-7 m-0">Domande?</p>
            ...
            <a href="" className="text-decoration-none text-secondary  mb-3">
              <div className="d-flex justify-content-start align-items-center mb-3">
                ...
                <div>
                  <p className="text-decoration-none text-secondary fw-bold fs-7 m-0 text-truncate">Gestisci il tuo account e la tua privacy</p>
            ...
            <a href="" className="text-decoration-none text-secondary  mb-3">
              <div className="d-flex justify-content-start align-items-center mb-3">
                ...
                <div>
                  <p className="text-decoration-none text-secondary fw-bold fs-7 m-0">Trasparenza sui contenuti consigliati</p>
